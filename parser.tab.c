...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_REVELA = 9,                     /* REVELA  */
  YYSYMBOL_GATO = 10,                      /* GATO  */
  YYSYMBOL_PRETO = 11,                     /* PRETO  */
  YYSYMBOL_MUAHAHA = 12,                   /* MUAHAHA  */
  YYSYMBOL_COM = 13,                       /* COM  */
  YYSYMBOL_ENVENENADA = 14,                /* ENVENENADA  */
  YYSYMBOL_CICLOS = 15,                    /* CICLOS  */
